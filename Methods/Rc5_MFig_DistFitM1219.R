...
# usando la serie de precipitaci?n maxima en 24h de la estacion M1219 rellenada con missForest
...
cdfcomp(list(gamma.fit,gumbel.fit,lnorm.fit, norm.fit,weibull.fit), 
        ...
        horizontals = F, verticals = F, do.points = F)
